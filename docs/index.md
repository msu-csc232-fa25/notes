...
This site uses a number of admonitions to highlight notes, warnings, etc. 
See [Admonitions](https://squidfunk.github.io/mkdocs-material/reference/admonitions/)

!!! note "Something Else"

    This is a note whose title has been customized to say something else 
    than the default "Note"

??? note "Collapsable block"

    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et euismod
    nulla. Curabitur feugiat, tortor non consequat finibus, justo purus auctor
    massa, nec semper lorem quam in massa.

    Add + to ??? to make it expanded by default
...
``` c++ title="main.cpp" linenums="1" hl_lines="3"
int main()
{
  return EXIT_SUCCESS; 
}
